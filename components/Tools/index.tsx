...
export default function Tools() {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 max-w-6xl mx-auto">
            ...
            {/* Main Content */}
            <div className="md:col-span-9 md:max-h-[calc(100vh-10rem)] md:overflow-y-auto">
                                ...
                                >
                                    <div className="flex items-center justify-between mb-4">
                                        <div className="flex items-center gap-3">
                                            <div className="w-10 h-10 bg-white rounded-lg flex items-center justify-center ring-1 ring-gray-200 dark:ring-gray-800">
                                                <img
                                                    src={tool.logoUrl}
                                                    alt={`${tool.name} logo`}
