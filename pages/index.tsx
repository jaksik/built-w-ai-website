    ...
    <div className="space-y-12 py-3 md:py-16 lg:py-20">
      ...
      <section className="text-center space-y-6">
        <div className="flex items-baseline justify-center logo-font">
          ...
          <span className="text-2xl sm:text-2xl md:text-4xl lg:text-5xl font-medium px-2"> with </span>
          <span className="text-5xl sm:text-5xl md:text-7xl lg:text-7xl font-bold border-4 rounded-md  px-1 border-gray-700 dark:border-slate-300"> AI</span>
        </div>
